...
require_once('hooks/customize_woocommerce.php');
require_once('hooks/custom_post_type.php');

customPostType::create();
customPostType::create_model_meta_boxes();
customPostType::save_meta_post();

CustomizeWC::add_product_meta();
